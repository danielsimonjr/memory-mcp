...
describe('MCPServer Integration', () => {
  ...
  describe('Tool Registration', () => {
    it('should have 241 tool definitions available', () => {
      ...
      // v12.7.0: 16 tools for memoryjs v3.0.0 — Event Memory (record_event, get_event,
      ...
      //   save_reconstructive_memory, load_reconstructive_memory),
      //   Relation Consolidation (analyze_relation_duplicates, consolidate_relations),
      //   Agent Reflection (create_reflection, list_reflections,
      //   get_relevant_reflections, archive_reflection).
      expect(toolDefinitions).toHaveLength(241);
    });
